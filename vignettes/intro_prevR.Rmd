...
- Larmarange Joseph and Bendaud Victoria (2014) "HIV estimates at second subnational level from national population-based survey", AIDS, n° 28, p. S469-S476, DOI: [10.1097/QAD.0000000000000480](http://dx.doi.org/10.1097/QAD.0000000000000480)
...
res <- quick.prevR(fdhs, N = c(150, 300, 450), return.results = TRUE, return.plot = TRUE, plot.results = FALSE, progression = FALSE, nb.cells = 50)
res$plot
```
...
dhs <- rings(dhs, N = c(100, 200, 300, 400, 500), progression = FALSE)
print(dhs)
summary(dhs)
